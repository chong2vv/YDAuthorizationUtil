#
# Be sure to run `pod lib lint YDAuthorizationUtil.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'YDAuthorizationUtil'
  s.version          = '0.1.0'
  s.summary          = 'A short description of YDAuthorizationUtil.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'YDAuthorizationUtil' => ['YDAuthorizationUtil/Assets/*.png']
  # }
